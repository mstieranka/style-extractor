...
const TEST_CASES: TestCase[] = [
	{
		...
		inputFile: "data/dembrandt/01-material.input.json",
		outputFile: "data/dembrandt/01-material.output.json",
		deltaEScoreThreshold: 75,
	},
	{
		name: "M365",
		inputFile: "data/dembrandt/02-m365.input.json",
		outputFile: "data/dembrandt/02-m365.output.json",
		deltaEScoreThreshold: 75,
	},
	{
		name: "Carbon Design",
		inputFile: "data/dembrandt/03-carbon.input.json",
		outputFile: "data/dembrandt/03-carbon.output.json",
		deltaEScoreThreshold: 75,
	},
	{
		name: "Zed",
		inputFile: "data/dembrandt/04-zed.input.json",
		outputFile: "data/dembrandt/04-zed.output.json",
		deltaEScoreThreshold: 80,
	},
	{
		name: "Recombee",
		inputFile: "data/dembrandt/05-recombee.input.json",
		outputFile: "data/dembrandt/05-recombee.output.json",
		deltaEScoreThreshold: 65,
	},
	{
		name: "Stripe",
		inputFile: "data/dembrandt/06-stripe.input.json",
		outputFile: "data/dembrandt/06-stripe.output.json",
		deltaEScoreThreshold: 85,
	},
	{
		name: "React.dev",
		inputFile: "data/dembrandt/07-react.input.json",
		outputFile: "data/dembrandt/07-react.output.json",
		deltaEScoreThreshold: 80,
	},
	{
		name: "Reddit",
		inputFile: "data/dembrandt/08-reddit.input.json",
		outputFile: "data/dembrandt/08-reddit.output.json",
		deltaEScoreThreshold: 70,
	},
	{
		name: "The Guardian",
		inputFile: "data/dembrandt/09-guardian.input.json",
		outputFile: "data/dembrandt/09-guardian.output.json",
		deltaEScoreThreshold: 65,
	},
	{
		name: "Hacker News",
		inputFile: "data/dembrandt/10-hackernews.input.json",
		outputFile: "data/dembrandt/10-hackernews.output.json",
		deltaEScoreThreshold: 80,
	},
];
 ...
 */
function paletteToPrediction(palette: ThemePalette): TokenRecord {
	return {
		color: {
	...
	TEST_CASES.forEach((testCase) => {
		describe(testCase.name, () => {
			it(`should extract palette from ${testCase.inputFile} matching ${testCase.outputFile}`, () => {
				...
				// 5. Convert extracted palette to prediction format
