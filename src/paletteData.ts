...
export const paletteData = [
  {
    ...
    palettes: [
      ...
      ...(await getUniquePalettes(
        (await import("../data/llm/gpt-5-nano/01-material.json")).default,
        "LLM - gpt-5-nano",
      )),
      ...(await getUniquePalettes(
        (await import("../data/llm/gemma-3-12b-it/01-material.json")).default,
        "LLM - gemma-3-12b-it",
      )),
    ],
  },
  {
    ...
    palettes: [
      ...
      ...(await getUniquePalettes(
        (await import("../data/llm/gpt-5-nano/02-m365.json")).default,
        "LLM - gpt-5-nano",
      )),
    ],
  },
  {
    ...
    palettes: [
      ...
      ...(await getUniquePalettes(
        (await import("../data/llm/gpt-5-nano/03-carbon.json")).default,
        "LLM - gpt-5-nano",
      )),
    ],
  },
  {
    ...
    palettes: [
      ...
      ...(await getUniquePalettes(
        (await import("../data/llm/gpt-5-nano/04-zed.json")).default,
        "LLM - gpt-5-nano",
      )),
    ],
  },
  {
    ...
    palettes: [
      ...
      ...(await getUniquePalettes(
        (await import("../data/llm/gpt-5-nano/05-recombee.json")).default,
        "LLM - gpt-5-nano",
      )),
    ],
  },
  {
    ...
    palettes: [
      ...
      ...(await getUniquePalettes(
        (await import("../data/llm/gpt-5-nano/06-stripe.json")).default,
        "LLM - gpt-5-nano",
      )),
    ],
  },
  {
    ...
    palettes: [
      ...
      ...(await getUniquePalettes(
        (await import("../data/llm/gpt-5-nano/07-react.json")).default,
        "LLM - gpt-5-nano",
      )),
    ],
  },
  {
    ...
    palettes: [
      ...
      ...(await getUniquePalettes(
        (await import("../data/llm/gemma-3-12b-it/08-reddit.json")).default,
        "LLM - gemma-3-12b-it",
      )),
      ...(await getUniquePalettes(
        (await import("../data/llm/gpt-5-nano/08-reddit.json")).default,
        "LLM - gpt-5-nano",
      )),
    ],
  },
  {
    ...
    palettes: [
      ...
      ...(await getUniquePalettes(
        (await import("../data/llm/gpt-5-nano/09-guardian.json")).default,
        "LLM - gpt-5-nano",
      )),
    ],
  },
  {
    ...
    palettes: [
      ...
      {
        method: "Dembrandt + post-processing",
        color: (await import("../data/dembrandt/10-hackernews.output.json"))
          .color,
      },
      ...(await getUniquePalettes(
        (await import("../data/llm/gemma-3-12b-it/10-hackernews.json")).default,
        "LLM - gemma-3-12b-it",
      )),
      ...(await getUniquePalettes(
        (await import("../data/llm/gpt-5-nano/10-hackernews.json")).default,
        "LLM - gpt-5-nano",
      )),
    ],
  },
...
async function getUniquePalettes(
  ...
  return deepUnique(data).map((entry: any, idx: number) => ({
