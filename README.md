...
- **Shared utilities** (`packages/shared`): shared code and types for the above parts. Also includes a CSS cleaner that removes all CSS declarations from a stylesheet that aren't necessary for the palette extraction (to save tokens).
