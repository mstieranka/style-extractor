...
import { getContrastRatio, getHue, getSaturation } from "./colorUtils";
import {
 ...
 * @returns ColorPaletteOptions containing semantic color roles
 */
export function extractPalette(cssString: string): ColorPaletteOptions {
	// 1. Parse CSS
	...
	const palette: ColorPaletteOptions = {
